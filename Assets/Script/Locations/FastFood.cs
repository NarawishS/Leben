...
namespace Script.Locations
{
    public class FastFood : MonoBehaviour
    {
        ...
        public void Work()
        {
            ...
            {
                coinSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: work at {Job.FastFood}");
            ...
            {
                actionFailSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: You did not apply for {Job.FastFood}");
            }
        }
    }
}