...
namespace Script.Locations
{
    public class Market : MonoBehaviour
    {
        ...
        public void Work()
        {
            ...
            {
                coinSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: work at {Job.Market}");
            ...
            {
                actionFailSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: You did not apply for {Job.Market}");
            }
        }
    }
}