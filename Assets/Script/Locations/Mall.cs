...
namespace Script.Locations
{
    public class Mall : MonoBehaviour
    {
        ...
        public void Work()
        {
            ...
            {
                coinSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: work at {Job.Mall}");
            ...
            {
                actionFailSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: You did not apply for {Job.Mall}");
            }
        }
    }
}