...
namespace Script.Locations
{
    public class VehicleShop : MonoBehaviour
    {
        ...
        public void Work()
        {
            ...
            {
                coinSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: work at {Job.Vehicle}");
            ...
            {
                actionFailSFX.Play();
                GameManager.Instance.ShowFloatingText($"{player.GetName()}: You did not apply for {Job.Vehicle}");
            }
        }
    }
}